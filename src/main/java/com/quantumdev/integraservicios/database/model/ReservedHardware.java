...
/**
 * Entity class representing a ReservedHardware in the database.
 * This class is mapped to the "ReservedHardware" table and contains fields for reserved hardware details.
