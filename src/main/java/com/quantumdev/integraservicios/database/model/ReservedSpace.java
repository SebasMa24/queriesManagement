...
/**
 * Entity class representing a ReservedSpace in the database.
 * This class is mapped to the "ReservedSpace" table and contains fields for reserved hardware details.
